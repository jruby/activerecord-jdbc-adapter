...
adapters are available:
  ...
  * mssql (activerecord-jdbcmssql-adapter). Does not support SQL Azure by default, see the project's readme[/jruby/activerecord-jdbc-adapter/blob/master/activerecord-jdbcmssql-adapter/README.rdoc] for more information.
