...
module ArJdbc
  module HSQLDB
    ...
    def modify_types(types)
      super(types)
      types[:primary_key] = "INTEGER GENERATED BY DEFAULT AS IDENTITY(START WITH 0) PRIMARY KEY"
      types[:integer][:limit] = nil
      types[:boolean][:limit] = nil
      # set text and float limits so we don't see odd scales in migrations :
      types[:boolean] = { :name => "tinyint" }
