...
module ::ArJdbc
  module Derby
    ...
    def modify_types(types)
      super(types)
      types[:primary_key] = "int generated by default as identity NOT NULL PRIMARY KEY"
      types[:string][:limit] = 256
      types[:integer][:limit] = nil
      types[:boolean] = {:name => "smallint"}
      types[:datetime] = {:name => "timestamp", :limit => nil}
      types[:timestamp][:limit] = nil
      types[:date][:limit] = nil
      types
    end
